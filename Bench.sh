...
for((MSIZE=2000; MSIZE<20000; MSIZE+=2000));
do
NSIZE=$MSIZE
#make TARGET=run cp_option="-o para -DNT1=$NT1 -DNT2=$NT2 -DKB=$KB -DL1_DIST_A=${L1_DIST_A} -DL1_DIST_B=${L1_DIST_B} -DNB=$NB"
make TARGET=run cp_option="-o para -DNT1=$NT1 -DNT2=$NT2 -DKB=$KB -DL1_DIST_A=${L1_DIST_A} -DL1_DIST_B=${L1_DIST_B} -DMSIZE=$MSIZE -DNSIZE=$NSIZE"
sleep 2
./para
sleep 2
./para
